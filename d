...
-------------------------------------------------------------------------------------------------> Blacklisted 
-- Termotanque3000
if game:service('Players').LocalPlayer.UserId == 47755042 then

wait(1)
game.Players.LocalPlayer:Kick("You've been Blacklisted form Aurora X! (Reason: Being an absolute asshole to people around you)")
screenGui:Destroy()
end
